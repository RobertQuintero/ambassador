...
const BarbershopServicesList = ({subServices}: BarbershopServicesListProps) => {
  ...
  return (
    <React.Fragment>
      ...
      >
          ...
          >
            Our barbershop offers a variety of services to meet your grooming
            needs. We offer haircuts, shaves, and more.
          </p>
      </AnimatedDivLeftRightUpDown>
